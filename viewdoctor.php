...
$sql = "SELECT * FROM viewdoctors";
$result = $conn->query($sql);

if ($result->num_rows > 0){
    while($row=$result->fetch_assoc()){
        echo  "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["qualification"]."</td><td>".$row["email"]."</td><td>".$row["category"]."</td><td>".$row["contact"]."</td><td>".$row["consultancyfee"]."</td><td>".$row["experience"]."</td><td>".$row["password"]."</td><tr>";
